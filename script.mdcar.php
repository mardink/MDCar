...
class Com_MdcarInstallerScript
{
	/**
...
<?php $rows = 1;?>
<img src="../media/com_mdcar/images/envelop64x64.png" width="64" height="64" alt="Md Contact" align="right" />

<h2>Welcome to MDCar!</h2>
...
<table class="adminlist">
	...
	<tbody>
		<tr class="row0">
			<td class="key" colspan="2">MDCar component</td>
...
<table class="adminlist">
	...
	<tbody>
		<tr class="row0">
			<td class="key" colspan="2"><?php echo 'MDCar'; ?></td>
